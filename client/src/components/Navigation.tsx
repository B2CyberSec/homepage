          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="text-sm font-medium text-[#1d1d1f]/70 hover:text-[#1d1d1f] transition-colors duration-200"
            ...
            <div className="flex items-center gap-3">
              ...
              <div
                ...
                className="hidden sm:flex items-center text-[11px] tracking-wider rounded-full border border-black/10 bg-white/60 backdrop-blur overflow-hidden"
              >
                <button
                  type="button"
                ...
                className={`px-2.5 py-1 transition-colors ${
                  lang === "de" ? "bg-[#1d1d1f] text-white font-semibold" : "text-[#1d1d1f]/70 hover:text-[#1d1d1f]"
                }`}
              >
                DE
                </button>
                ...
                className={`px-2.5 py-1 transition-colors ${
                  lang === "en" ? "bg-[#1d1d1f] text-white font-semibold" : "text-[#1d1d1f]/70 hover:text-[#1d1d1f]"
                }`}
              >
                EN
                </button>
      ...
      >
        <div className="flex flex-col items-center justify-center h-full gap-7">
          ...
          <div
            role="group"
            aria-label={t("lang.switchTo")}
            className="mt-2 flex items-center text-sm tracking-wider rounded-full border border-black/10 bg-white/60 overflow-hidden"
          >
            <button
              type="button"
              onClick={() => switchLang("de")}
              aria-pressed={lang === "de"}
                ...
                lang === "de" ? "bg-[#1d1d1f] text-white font-semibold" : "text-[#1d1d1f]/70"
              }`}
            >
              DE
            </button>
            <button
              ...
              aria-pressed={lang === "en"}
                className={`px-4 py-1.5 transition-colors ${
                lang === "en" ? "bg-[#1d1d1f] text-white font-semibold" : "text-[#1d1d1f]/70"
              }`}
            >
              EN
            </button>
