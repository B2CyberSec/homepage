 ...
 * Hero: Subtle dark geometric background. Text is the star, not the image.
 * "Weniger ist mehr" — the typography does the talking.
 */
import { useEffect, useState } from "react";
import { ChevronDown } from "lucide-react";
import { useLanguage } from "@/contexts/LanguageContext";

const HERO_BG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663406320538/nFZEie8kzRFKviGqGmc9gt/hero_subtle_v4-fSjnATHyqpELZvCFw6zMrm.webp";
...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-end overflow-hidden">
      {/* Full-bleed background — subtle dark texture, text is the star */}
      <div className="absolute inset-0">
        <img
          src={HERO_BG}
          alt="B2CyberSec — IT Security Solutions"
