    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container pt-32 pb-20">
        <div className="max-w-5xl">
          {/* Tag */}
          <div className={`inline-flex items-center gap-2 mb-8 transition-all duration-700 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            <span className="inline-block w-2 h-2 bg-[#ff4500] rounded-full animate-pulse" />
            <span className="text-[#ff4500] text-sm font-bold uppercase tracking-[0.2em]" style={{ fontFamily: "var(--font-mono)" }}>
              {t("hero.spoiler")}
            </span>
          </div>
          ...
          {/* Main Headline */}
          <h1
            className={`text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[6.5rem] font-bold leading-[0.9] tracking-tight mb-8 transition-all duration-1000 delay-200 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          ...
          {/* Subheadline */}
          <p className={`text-lg md:text-xl lg:text-2xl text-white/60 max-w-2xl leading-relaxed mb-4 transition-all duration-1000 delay-500 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            {t("hero.sub1")}
            <span className="text-[#ff4500] font-bold">{t("hero.sub_expired")}</span>
            {t("hero.sub2")}
            <span className="text-white font-bold">{t("hero.sub3")}</span>.
          </p>

          <p
            className={`text-base md:text-lg text-white/40 max-w-xl mb-12 transition-all duration-1000 delay-700 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          ...
          {/* CTAs */}
          <div className={`flex flex-col sm:flex-row gap-4 transition-all duration-1000 delay-900 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <a
              href={calendlyUrl}
              target="_blank"
