...
export const translations = {
  de: {
    ...
    "as.q8": "Hat Ihr Unternehmen einen dokumentierten und **getesteten Notfall-Plan** mit klar definierten Rollen und Eskalationswegen?",
  ...
  en: {
    ...
    "as.q5": "Do you regularly receive **understandable cybersecurity risk reports** that enable informed decisions at board level?",
