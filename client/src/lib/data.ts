...
export const STAFF_AUGMENTATION = [
  {
    id: "nearshore",
    name: "Nearshore (Bosnien & Herzegowina)",
    description: "IT-Security-Experten aus Bosnien und Herzegowina, remote. Gleiche Zeitzone, niedrigere Kosten, höchste Qualität.",
    rate: "65–85 €/h",
    availability: "Ab 48 Stunden",
    features: [
      "Gleiche Zeitzone (CET)",
  ...
  {
    id: "onshore",
    name: "Onshore (Deutschland)",
    description: "IT-Security-Experten in Deutschland, vor Ort oder remote. Für Projekte, die lokale Präsenz erfordern.",
    rate: "115–120 €/h",
    ...
    features: [
      ...
      "Flexible Einsatzdauer",
      "Projektbasiert oder langfristig",
    ],
  },
];
...
export const NAV_ITEMS = [
  ...
  { label: "Experten auf Zeit", href: "/experten" },
