          ...
          <div className="space-y-10 text-white/70" style={{ fontFamily: "'Inter', sans-serif" }}>
            ...
            <section>
              ...
              <div className="glass-card rounded-xl p-6 space-y-1 text-sm leading-relaxed">
                ...
                <p className="mt-3">Werner-von-Siemens-Straße 6</p>
                <p>86159 Augsburg, Deutschland</p>
                ...
                <p className="mt-3 text-white/50 text-xs uppercase tracking-wider" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Gründungsjahr</p>
            ...
            <section>
              ...
              <div className="glass-card rounded-xl p-6 space-y-2 text-sm leading-relaxed">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:info@b2cybersec.com" className="hover:text-white transition-colors">info@b2cybersec.com</a>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-4 h-4 text-[#0A84FF] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <section>
              ...
              <div className="glass-card rounded-xl p-6 text-sm leading-relaxed space-y-1">
                ...
                <p>Handelsregisternummer: <span className="text-white">HRB 33545</span></p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="glass-card rounded-xl p-6 text-sm leading-relaxed">
                ...
                <p className="text-white mt-2">DE 323792746</p>
              </div>
            </section>
